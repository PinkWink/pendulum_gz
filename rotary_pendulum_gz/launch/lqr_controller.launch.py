        ...
        parameters=[
            {
                ...
                "lqr_enable_pole_angle_deg": 60.0,
                "lqr_enable_pole_vel_rad_s": 8.0,
                "lqr_disable_pole_angle_deg": 75.0,
                "lqr_disable_pole_vel_rad_s": 16.0,
                "lqr_stay_on_capture": True,
                "velocity_filter_alpha": 0.85,
                "voltage_slew_rate_v_per_s": 60.0,
                "enable_swing_up": True,
                "swing_up_gain": 5.0,
